...
abstract class StripeCore extends AbstractPaymentProvider<StripeOptions> {
    ...
    normalizePaymentIntentParameters(
        ...
        (res as any).shared_payment_token = extra?.shared_payment_token as string | undefined
